...
def start_treo_poll_func(cookie, idbox, delay_str, folder_name):
...
def stop_treo_poll(folder_name):
...
if __name__ == "__main__":
    ...
    thread_id = "24065311806495886"  
    delay = "30" 
    folder_name = "test_folder"

    os.makedirs(os.path.join("data", folder_name), exist_ok=True)

    start_treo_poll_func(cookie, thread_id, delay, folder_name)